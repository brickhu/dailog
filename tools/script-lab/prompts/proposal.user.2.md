...
* Report levels and quotes. **Do not compute the total yourself** — the arithmetic is done outside this document.
...
Do not add a new field for Scene Type or Public Thinking Value.
